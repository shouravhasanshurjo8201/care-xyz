          ...
          <div className="lg:col-span-1">
            <div className="bg-amber-50 p-8 rounded-[2.5rem] shadow-xl shadow-slate-200/60 border border-slate-100 sticky top-10">
              ...
              <button
                ...
                className="w-full bg-emerald-600 text-white py-5 rounded-3xl font-black text-lg hover:bg-emerald-700 hover:scale-[1.02] transition-all shadow-lg shadow-emerald-200 active:scale-95"
              >
                Book Now
              </button>
